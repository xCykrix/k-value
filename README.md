...
k-value Node.js Map-like API based key-value storage with multiple persistent backend adapters.
...
You can visit our [GitHub Wiki](https://github.com/amethyst-studio/k-value/wiki) for information in setting up and using this service.
...
You can find our API Auto-Generated Documentation available at our [GitHub Pages](https://amethyst-studio.github.io/k-value/index.html).

...
import type { KValueTable, MySQL2Options } from '../abstraction/adapter'
...
export class MySQLAdapter extends Adapter {
  private readonly options: MySQL2Options & CacheOptions
  private readonly driver: KnexHandler

  public constructor (options: MySQL2Options & CacheOptions & { useNullAsDefault: boolean; }) {
    super()

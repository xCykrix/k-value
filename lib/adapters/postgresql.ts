...
import type { PostgreSQLOptions } from '../abstraction/adapter/sql';
 ...
 * @remarks
 *
 * This adapter uses 'pg' to provide a PostgreSQL database. You must install this package manually.
 */
export class PostgreSQLAdapter extends SQLAdapter {
  protected override readonly options: PostgreSQLOptions;

  /**
   * Initalize PostgreSQL storage adapter.
   *
   * @remarks
   *
   * This adapter uses 'pg' to provide a PostgreSQL database. You must install this package manually.
   *
   * useNullAsDefault is not available for modification. It will always be set to true due to PostgreSQL driver limitations.
   *
  ...
  /**
   * Configure the PostgreSQL storage adapter connection.
   *
   * @remarks
   *

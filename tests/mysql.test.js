...
describe("Adapter::MySQLAdapter", function() {
  ...
  it("MySQLAdapter::set()->get()", async function() {
    // Basic set()
  ...
  it("MySQLAdapter::set():USE_MERGE->get()", async function() {
  ...
  it("MySQLAdapter::set():USE_LIFETIME->get()", async function() {
  ...
  it("MySQLAdapter::get()", async function() {
  ...
  it("MySQLAdapter::get():USE_DEFAULT", async function() {
  ...
  it("MySQLAdapter::get():USE_CACHE", async function() {
    // Feature of get() { cache: true }
    expect(await kv.get("read-test-1", { cache: true })).to.deep.equal({
      read: true
    });
  ...
  it("MySQLAdapter::has()", async function() {
  ...
  it("MySQLAdapter::keys()", async function() {
  ...
  it("MySQLAdapter::keys():USE_LIMITER", async function() {
  ...
  it("MySQLAdapter::delete()", async function() {
  ...
  // Error Checking
  it("MySQLAdapter::state_diagnostics", async function() {
  ...
  it("MySQLAdapter::clear()", async function() {
    await kv.clear();
  ...
  it("MySQLAdapter::close()", async function() {
